        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassRooms_Accounts_CreatedUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Learners_Accounts_CreatedUserId",
                        column: x => x.CreatedUserId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lectures_Accounts_AccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subjects_Accounts_CreatedUserId",
                        column: x => x.CreatedUserId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Permissions", x => new { x.UserId, x.RoleId });
                    table.ForeignKey(
                        name: "FK_Permissions_Accounts_UserId",
                        column: x => x.UserId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Permissions_Functions_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Functions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LectureSchedules_Learners_LeanerId",
                        column: x => x.LeanerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassRooms_CreatedUserId",
                table: "ClassRooms",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Learners_CreatedUserId",
                table: "Learners",
                column: "CreatedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Lectures_AccountId",
                table: "Lectures",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_LectureSchedules_LeanerId",
